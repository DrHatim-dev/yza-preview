...
const STR = {
  ...
  'charm.style.text': { fr: 'Un fruit en raphia s’accroche partout — sur un panier en cuir, un sac bien structuré, une besace matelassée. Un clip, une couleur qui chante, et le sac n’est plus tout à fait comme celui de la voisine.', en: 'A raffia fruit clips onto anything — a leather tote, a crisp structured bag, a quilted shoulder bag. One clasp, one colour that sings, and the bag stops looking like everyone else’s.' },
  'charm.style.cap1': { fr: 'Sur un panier en cuir', en: 'On a leather tote' },
  'charm.style.cap2': { fr: 'Sur un sac structuré noir', en: 'On a structured black bag' },
  'charm.style.cap3': { fr: 'Sur une besace matelassée', en: 'On a quilted shoulder bag' },
