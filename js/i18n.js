...
const STR = {
  ...
  'home.shipping':   { fr: 'Livraison offerte au Maroc selon la catégorie', en: 'Free Morocco delivery by category', es: 'Envío gratis en Marruecos según la categoría', tr: 'Kategoriye göre Fas içi ücretsiz teslimat', ar: 'توصيل مجاني داخل المغرب حسب الفئة' },
  ...
  'wishlist.add':    { fr: 'Ajouter aux favoris', en: 'Add to wishlist', es: 'Añadir a favoritos', tr: 'Favorilere ekle', ar: 'أضيفي إلى المفضلة' },
  'wishlist.remove': { fr: 'Retirer des favoris', en: 'Remove from wishlist', es: 'Quitar de favoritos', tr: 'Favorilerden çıkar', ar: 'أزيلي من المفضلة' },
  ...
  'co.ship.recoveryConsent': { fr: 'J’accepte de recevoir par e-mail des rappels concernant uniquement ce panier. Ce choix est facultatif et ne m’inscrit pas à la newsletter.', en: 'I agree to receive email reminders solely about this cart. This is optional and does not subscribe me to the newsletter.', es: 'Acepto recibir por correo recordatorios únicamente sobre esta cesta. Es opcional y no me suscribe al boletín.', tr: 'Yalnızca bu sepetle ilgili e-posta hatırlatıcıları almayı kabul ediyorum. Bu isteğe bağlıdır ve beni bültene kaydetmez.', ar: 'أوافق على تلقي تذكيرات عبر البريد الإلكتروني تخص هذه السلة فقط. هذا اختياري ولا يشتركني في النشرة البريدية.' },
  ...
  'co.order.placing': { fr: 'Enregistrement…', en: 'Recording order…', es: 'Registrando pedido…', tr: 'Sipariş kaydediliyor…', ar: 'جارٍ تسجيل الطلب…' },
  'co.order.retry': { fr: 'Réessayer', en: 'Retry', es: 'Reintentar', tr: 'Tekrar dene', ar: 'حاولي مجددًا' },
  'co.order.fallback': { fr: 'Continuer sur WhatsApp', en: 'Continue on WhatsApp', es: 'Continuar por WhatsApp', tr: 'WhatsApp ile devam et', ar: 'المتابعة عبر واتساب' },
  'co.order.failed': { fr: 'La commande n’a pas pu être enregistrée. Votre panier et vos coordonnées sont conservés.', en: 'We could not record the order. Your cart and details have been kept.', es: 'No pudimos registrar el pedido. Conservamos tu cesta y tus datos.', tr: 'Sipariş kaydedilemedi. Sepetiniz ve bilgileriniz korundu.', ar: 'تعذّر تسجيل الطلب. احتفظنا بسلّتك وبياناتك.' },
  'co.order.conflict': { fr: 'Cette référence existe peut-être déjà avec un autre contenu. Votre panier est conservé — contactez l’atelier sur WhatsApp.', en: 'This reference may already exist with different contents. Your cart is safe — contact the atelier on WhatsApp.', es: 'Esta referencia puede existir con otro contenido. Tu cesta está guardada — contacta al atelier por WhatsApp.', tr: 'Bu referans farklı bir içerikle zaten mevcut olabilir. Sepetiniz korundu — WhatsApp’tan atölyeye yazın.', ar: 'قد يكون هذا المرجع موجودًا بمحتوى مختلف. سلّتك محفوظة — تواصلي مع الأتيليه عبر واتساب.' },
  'co.order.pending': { fr: 'Votre commande est bien enregistrée. Nous finalisons la désactivation des rappels de panier ; réessayez dans un instant.', en: 'Your order is recorded. We are finishing the cart-reminder suppression; please retry in a moment.', es: 'Tu pedido está registrado. Estamos terminando de desactivar los recordatorios; vuelve a intentarlo en un momento.', tr: 'Siparişiniz kaydedildi. Sepet hatırlatıcılarını kapatıyoruz; lütfen birazdan tekrar deneyin.', ar: 'تم تسجيل طلبك. نُكمل إيقاف تذكيرات السلة؛ يرجى المحاولة مجددًا بعد لحظة.' },
  ...
  'co.pay.ibanTxt':  { fr: "Pour l'international, en euros — depuis Revolut, Wise, N26 ou toute banque. Envoyez le reçu sur WhatsApp.", en: 'For international orders, in euros — from Revolut, Wise, N26 or any bank. Send the receipt on WhatsApp.', es: 'Para pedidos internacionales, en euros — desde Revolut, Wise, N26 o cualquier banco. Envía el recibo por WhatsApp.', tr: 'Uluslararası siparişler için, euro olarak — Revolut, Wise, N26 veya herhangi bir bankadan. Dekontu WhatsApp’tan gönderin.', ar: 'للطلبات الدولية، باليورو — من Revolut أو Wise أو N26 أو أي بنك. أرسلي الإيصال عبر واتساب.' },
  'co.pay.paypal':   { fr: 'PayPal ou carte bancaire', en: 'PayPal or card', es: 'PayPal o tarjeta', tr: 'PayPal veya kart', ar: 'باي بال أو بطاقة' },
  'co.pay.paypalTxt':{ fr: 'Payez en ligne par PayPal ou carte (Visa, Mastercard, Amex) — sans compte PayPal.', en: 'Pay online with PayPal or card (Visa, Mastercard, Amex) — no PayPal account needed.', es: 'Paga en línea con PayPal o tarjeta (Visa, Mastercard, Amex) — sin cuenta PayPal.', tr: 'PayPal veya kartla çevrimiçi ödeyin (Visa, Mastercard, Amex) — PayPal hesabı gerekmez.', ar: 'ادفعي عبر باي بال أو بالبطاقة (Visa، Mastercard، Amex) — دون حساب باي بال.' },
...
const EXTRA = {
  ...
  'alt.home.campaign':      { fr: 'Campagne YZA au Maroc avec le vestiaire Jawhara et les pièces artisanales de la maison', en: 'YZA campaign in Morocco featuring the Jawhara wardrobe and the house’s handcrafted pieces', es: 'Campaña YZA en Marruecos con el vestuario Jawhara y las piezas artesanales de la casa', tr: 'Fas’taki YZA kampanyasında Jawhara gardırobu ve evin el yapımı parçaları', ar: 'حملة YZA في المغرب مع أزياء Jawhara وقطع الدار المصنوعة يدوياً' },
  'alt.home.atelier':       { fr: 'Les artisanes YZA réunies autour de la table de l’atelier à Guéliz', en: 'YZA artisans gathered around the atelier table in Guéliz', es: 'Las artesanas de YZA reunidas alrededor de la mesa del atelier en Guéliz', tr: 'YZA zanaatkârları Guéliz’deki atölye masasının etrafında', ar: 'حرفيات YZA مجتمعات حول طاولة المشغل في كليز' },
  'alt.home.sculpture':     { fr: 'La Sculpture Hot Red portée avec une silhouette Jawhara ivoire', en: 'The Hot Red La Sculpture worn with an ivory Jawhara silhouette', es: 'La Sculpture Hot Red con una silueta Jawhara marfil', tr: 'Fildişi Jawhara silüetiyle taşınan Hot Red La Sculpture', ar: 'حقيبة La Sculpture باللون الأحمر مع إطلالة Jawhara عاجية' },
  ...
  'contact.resellers.title': { fr: 'Commercial', en: 'Commercial / Wholesale', es: 'Comercial', tr: 'Ticari satış', ar: 'القسم التجاري' },
  ...
  'contact.resellers.cta': { fr: 'Demander le catalogue', en: 'Request the catalogue', es: 'Pedir el catálogo', tr: 'Kataloğu iste', ar: 'اطلبي الكتالوج' },
};
