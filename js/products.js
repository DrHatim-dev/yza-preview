...
YZA.brand = {
 ...
 emailSupport: 'contact@yza-shop.com',
 emailB2b: 'contact@yza-shop.com',
...
YZA.serviceFeatures = [
 ...
 key: 'handmade',
 icon: 'handmade',
 title: { fr: 'Fait main', en: 'Handmade', es: 'Hecho a mano', tr: 'El yapımı', ar: 'صناعة يدوية' },
 text: { fr: "Chaque pièce est faite main à l'atelier de Guéliz. Pas de machine, pas de sous-traitance — venez le vérifier chez nous, la porte est ouverte.", en: "Every piece is handmade at the Guéliz atelier. No machine, no outsourcing — come and check for yourself, the door is open.", es: "Cada pieza está hecha a mano en el atelier de Guéliz. Sin máquina, sin subcontratación — ven a comprobarlo, la puerta está abierta.", tr: "Her parça Guéliz atölyesinde el yapımıdır. Makine yok, fason yok — gelip kendiniz görün, kapımız açık.", ar: "كل قطعة مصنوعة يدويًا في أتيليه كليز. لا آلة ولا مناولة — تعالَي وتحقّقي بنفسك، الباب مفتوح." },
 short: { fr: 'Fait main', en: 'Handmade', es: 'Hecho a mano', tr: 'El yapımı', ar: 'يدوي' },
 },
 {
 key: 'payment',
 icon: 'payment',
